					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cash Pooling &amp; Call deposit App",
									"targetURL": "#zurichfscmuicpcd-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"ZZ9FSCM_CP-Manage": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zurich.fscm.ui.cpcd",
									"url": sap.ui.require.toUrl("zurich/fscm/ui/cpcd")
								}
							}
						}
					}
